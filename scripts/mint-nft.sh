...
# 컨트랙트 접근 확인
echo "Checking contract connectivity..."
cast call $NFT_ADDRESS "balanceOf(address)(uint256)" $RECIPIENT --rpc-url $RPC_URL >/dev/null
...
for i in $(seq 1 $REPEAT); do
  echo "Batch $i: Minting $BATCH_SIZE tokens..."
