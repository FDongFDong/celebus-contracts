...
import {CELEBUS} from "../src/token/CelbToken.sol";
import {IERC20Errors} from "@openzeppelin/contracts/interfaces/draft-IERC6093.sol";

contract CelbTokenPermitTest is Test {
    CELEBUS public token;
    ...
    function setUp() public {
        ...
        token = new CELEBUS(tokenOwner, address(this));
    ...
    function test_permit_wrong_verifying_contract_reverts() public {
        ...
        CELEBUS otherToken = new CELEBUS(tokenOwner, address(this));
