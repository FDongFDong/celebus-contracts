      ...
      <div class="bg-white rounded-lg shadow p-6 mb-6 border-l-4 border-purple-500">
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div class="grid grid-cols-3 gap-3 mb-3">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Boosting ID (선택)</label>
              <input
                type="number"
                id="boostingIdFilter"
                class="w-full px-3 py-2 border rounded-md"
            ...
            <table class="w-full text-sm border-collapse">
              <thead>
                <tr class="bg-gray-100">
                  ...
                  <th class="border px-3 py-2 text-left">Boosting ID</th>
