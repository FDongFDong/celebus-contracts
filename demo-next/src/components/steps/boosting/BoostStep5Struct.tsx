...
export function BoostStep5Struct() {
  ...
  return (
    <StepCard
      stepNumber={5}
      title="구조체 해시 계산"
      description="Boosting 배치 nonce 기반 struct hash를 계산합니다"
      badgeColor="default"
    >
      <div className="space-y-4">
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="boostBatchNonce">배치 Nonce</Label>
        ...
        {structHash && (
          <div className="space-y-3">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="boostBatchTypeHash">배치 타입 해시</Label>
              <Input
                id="boostBatchTypeHash"
                type="text"
                value={batchTypeHash ?? ''}
                readOnly
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="boostStructHash">구조체 해시</Label>
              <Input
                id="boostStructHash"
                type="text"
                value={structHash}
