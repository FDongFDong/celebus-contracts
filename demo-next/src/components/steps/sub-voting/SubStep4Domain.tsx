...
export function SubStep4Domain() {
  ...
  const [name, setName] = useState('SubVoting');
  ...
  return (
    <StepCard
      stepNumber={4}
      title="도메인 구분자 계산"
      description="SubVoting EIP-712 도메인을 계산합니다"
      badgeColor="default"
    >
      <div className="space-y-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="subDomainName">도메인 이름</Label>
            <Input
              id="subDomainName"
              type="text"
              value={name}
              onChange={(e) => setName(e.target.value)}
              placeholder="SubVoting"
            />
          </div>

          <div className="flex flex-col gap-1.5">
            <Label htmlFor="subDomainVersion">도메인 버전</Label>
            <Input
              id="subDomainVersion"
              type="text"
              value={version}
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="subDomainChainId">체인 ID</Label>
            <Input
              id="subDomainChainId"
              type="number"
              value={chainId}
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="subDomainContract">검증 컨트랙트</Label>
            <Input
              id="subDomainContract"
              type="text"
        ...
        {domainSeparator && (
          <div className="space-y-3">
            <div>
              <Label htmlFor="subDomainSeparator">도메인 구분자</Label>
              <Input
                id="subDomainSeparator"
                type="text"
