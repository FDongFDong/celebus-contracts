 ...
 */
contract VIBENFT is ERC721, ERC721Pausable, Ownable, ERC721Burnable {
    // ============================================
    // 상태 변수
    // ============================================
    /// @dev 최대 배치 크기
    ...
    /**
     * @dev 컨트랙트 초기화
     * @param tokenName ERC721 name
     * @param tokenSymbol ERC721 symbol
     * @param initialBaseURI 초기 Base URI (빈 문자열 허용)
